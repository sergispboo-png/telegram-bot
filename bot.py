...
async def choose_mode(callback: CallbackQuery):
    ...
    model_map = {
    "model_nano": "google/gemini-2.5-flash-image",
    "model_pro": "google/gemini-2.5-flash-image",
    "model_seedream": "google/gemini-2.5-flash-image"
}

    model = model_map.get(callback.data)

    update_model(callback.from_user.id, model)
